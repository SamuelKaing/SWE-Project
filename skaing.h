...
extern void init_boss(int xres, int yres, Texture boss_tex, int level);
extern void boss_movement(int xres, int level);
extern void boss_behavior(struct timespec &boss_bulletTimer, int level);
